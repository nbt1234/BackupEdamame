            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <!-- form start -->
                        <form role="form" method="post" action="<?php url('admin/add-subadmin');?>"
                            enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="username">Username</label>
                                    <input type="text" name="username" class="form-control" id="username"
                                        placeholder="Enter subadmin username" value="<?php echo set_value('username') ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" class="form-control" id="email"
                                        placeholder="Enter subadmin email" value="<?php echo set_value('email') ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="password" class="form-control" id="password"
                                        placeholder="Enter subadmin password" value="<?php echo set_value('password') ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mobile" class="form-control" id="mobile"
                                        placeholder="Enter subadmin mobile" value="<?php echo set_value('mobile') ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="user_block_status" checked id="active_status" value="0">
                                        <label for="active_status" class="custom-control-label">Active</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="user_block_status" id="inactive_status" value="1">
