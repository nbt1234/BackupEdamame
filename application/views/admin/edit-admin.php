            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <!-- form start -->
                        <form role="form" method="post" action="<?php url('admin/update-profile/');?>"
                            enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="username">Username</label>
                                    <input type="text" name="username" class="form-control" id="username"
                                        placeholder="Enter admin username" value="<?php echo $admin_data['username'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" class="form-control" id="email"
                                        placeholder="Enter admin email" value="<?php echo $admin_data['email'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mobile" class="form-control" id="mobile"
                                        placeholder="Enter admin mobile" value="<?php echo $admin_data['mobile'] ?>">
                                    <?php echo form_error('mobile', '<div class="form-valid-error">', '</div>'); ?>
                                </div>

                                <div class="form-group">
                                    <label for="vendor-img">Logo</label>
                                    ...
                                    <?php if(!empty($admin_data['avatar'])){ ?>
                                       <img src="<?php url('site-assets/img/user-avatar/'.$admin_data['avatar']) ?>" class="sm-img">
                                    <?php } ?>   
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="user_block_status" id="active_status" value="0" <?php if($admin_data['user_block_status'] == 0){echo 'checked';} ?>>
                                        <label for="active_status" class="custom-control-label">Active</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" name="user_block_status" id="inactive_status" value="1"  <?php if($admin_data['user_block_status'] == 1){echo 'checked';} ?>>
