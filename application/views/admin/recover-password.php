...
<head>
  ...
  <title><?php echo APP_NAME ?> | Recover Password</title>
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      ?>
      <form action="<?php echo base_url('admin/verify-reset-password') ?>" method="post">
        ...
        <div class="input-group mb-3">
          ...
          <?php echo form_error('confirm_password', '<div class="form-valid-error">', '</div>'); ?>
        </div>
