...
class Common_model extends CI_Model
{
    ...
    public function get_full_data($fields = '', $table = '', $where = '', $order = '', $limit = '', $offset = '', $like = '')
    {
        ...
        if (!empty($like)) {
            $this->db->like($like['like_column'], $like['srch_text']);
        }
    ...
    public function find_set($table = '', $search = '', $field = '', $column = '', $where = '', $order = array(), $limit = '', $offset = '', $like = array(), $or_where = array())
    {
        $this->db->select($field);
        $this->db->from($table);
        $this->db->where("FIND_IN_SET('" . $search . "', " . $column . ")");
        if (!empty($where)) {
            $this->db->where($where);
        }
    ...
    public function join_model($table = '', $where = array(), $join = '', $select = '*', $order = array(), $or_where = array(), $limit = '', $offset = '', $like = array())
    {
